  ...
  async * stream(options: GenerateOptions): AsyncIterable<StreamChunk> {
    ...
    try {
      ...
      const context = mergeOptions === undefined
        ...
        : attachments === undefined
          ? toPiContext(options, undefined, onReplayDegrade, undefined, mergeOptions)
          : await toPiContext(options, attachments, onReplayDegrade, profile.maxRequestImageBytes, mergeOptions)
