...
export const zh = {
  ...
  'banner.body': '等待正在进行的回合到达安全边界后退出；正在执行的写工具最多等待 {capSeconds} 秒。',
...
export const en = {
  ...
  'banner.body': 'Waiting for live turns to settle at a safe boundary; in-flight write tools wait up to {capSeconds} seconds.',
