...
import {
  ...
  hostRequestRestartImmediateValueSchema,
...
export interface IApiClient {
  ...
  host: {
    ...
    requestRestartImmediate(payload: RequestPayload<'host.requestRestartImmediate'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.requestRestartImmediate'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'host.requestRestartImmediate': hostRequestRestartImmediateValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    requestRestartImmediate: (payload, signal) => this.callUnary('host.requestRestartImmediate', payload, signal),
