...
The workspace does not yet provide a TypeScript Cordis facade. The [Rust host replacement Agent Note](../../.agents/notes/proposed/architecture/2026-08-15-rust-host-replacement.md) owns the migration phases and acceptance criteria.
